...
if ( class_exists( 'GrandPrixCoreClassWidget' ) ) {
	class GrandPrixMikadoClassContactForm7Widget extends GrandPrixCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'mkdf_contact_form_7_widget',
				esc_html__( 'GrandPrix Contact Form 7 Widget', 'grandprix' ),
				array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'grandprix' ) )
			);
		...
		protected function setParams() {
			...
			$this->params = array(
				array(
					'type'  => 'textfield',
					'name'  => 'extra_class',
					'title' => esc_html__( 'Extra Class Name', 'grandprix' )
				),
				array(
					'type'  => 'textfield',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form',
					'title'   => esc_html__( 'Select Contact Form 7', 'grandprix' ),
					'options' => $contact_forms
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form_style',
					'title'   => esc_html__( 'Contact Form 7 Style', 'grandprix' ),
					'options' => array(
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="widget mkdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo grandprix_mikado_get_inline_style( $widget_styles ); ?>>
