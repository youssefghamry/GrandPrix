...
if ( ! function_exists('grandprix_mikado_breadcrumbs_title_type_options_map') ) {
	function grandprix_mikado_breadcrumbs_title_type_options_map($panel_typography) {
		
		grandprix_mikado_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'grandprix' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = grandprix_mikado_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'grandprix' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'grandprix' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = grandprix_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = grandprix_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = grandprix_mikado_add_admin_row(
				array(
	...
	add_action( 'grandprix_mikado_action_additional_title_typography_options_map', 'grandprix_mikado_breadcrumbs_title_type_options_map');
}