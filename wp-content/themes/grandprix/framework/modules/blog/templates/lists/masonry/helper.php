...
if ( ! function_exists( 'grandprix_mikado_get_blog_holder_params' ) ) {
	...
	function grandprix_mikado_get_blog_holder_params( $params ) {
		...
		$masonry_layout = grandprix_mikado_get_meta_field_intersect( 'blog_masonry_layout' );
...
if ( ! function_exists( 'grandprix_mikado_get_blog_list_classes' ) ) {
	/**
	 * Function that generates blog list holder classes for blog list templates
	 */
	function grandprix_mikado_get_blog_list_classes( $classes ) {
		$list_classes   = array();
		$list_classes[] = 'mkdf-grid-list mkdf-grid-masonry-list';
		
		$number_of_columns = grandprix_mikado_get_meta_field_intersect( 'blog_masonry_number_of_columns' );
		if ( ! empty( $number_of_columns ) ) {
			$list_classes[] = 'mkdf-' . $number_of_columns . '-columns';
		}
		
		$space_between_items = grandprix_mikado_get_meta_field_intersect( 'blog_masonry_space_between_items' );
	...
	add_filter( 'grandprix_mikado_filter_blog_list_classes', 'grandprix_mikado_get_blog_list_classes' );
}
