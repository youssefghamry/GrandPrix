...
if ( ! function_exists( 'grandprix_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function grandprix_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'grandprix_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'grandprix_mikado_header_main_navigation_options_map' ) ) {
	function grandprix_mikado_header_main_navigation_options_map() {
		$hide_dep_options = grandprix_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = grandprix_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'grandprix' ),
		...
		grandprix_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'grandprix' )
			)
		);
		
		$drop_down_group = grandprix_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'grandprix' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'grandprix' )
			)
		);
		
		$drop_down_row1 = grandprix_mikado_add_admin_row(
			array(
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'grandprix' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'grandprix' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'grandprix' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'grandprix' )
				)
			)
		);
		...
		$first_level_group = grandprix_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'grandprix' )
			)
		);
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'grandprix' ),
			)
		);
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'grandprix' ),
			)
		);
		
		$first_level_row4 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'grandprix' ),
			)
		);
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'grandprix' ),
			)
		);
		
		$first_level_row5 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'grandprix' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'grandprix' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = grandprix_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'grandprix' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'grandprix' )
			)
		);
		...
		grandprix_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'grandprix' )
			)
		);
		...
		$second_level_wide_group = grandprix_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'grandprix' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'grandprix' )
			)
		);
		
		$second_level_wide_row1 = grandprix_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = grandprix_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'grandprix' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'grandprix' )
			)
		);
		...
		$third_level_wide_group = grandprix_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'grandprix' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'grandprix' )
			)
		);
		
		$third_level_wide_row1 = grandprix_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = grandprix_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'grandprix_mikado_action_header_main_navigation_options_map', 'grandprix_mikado_header_main_navigation_options_map', 10, 1 );
}