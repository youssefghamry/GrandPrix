...
if (!class_exists('GrandPrixMikadoClassMobileNavigationWalker')) {
	class GrandPrixMikadoClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="mkdf-sub-arrow arrow_carrot-right"></i></span>';
				}
			}
