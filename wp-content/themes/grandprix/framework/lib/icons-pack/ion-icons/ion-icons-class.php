...
if ( ! function_exists( 'grandprix_mikado_add_ion_icon_pack' ) ) {
	function grandprix_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new GrandPrixMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_ion_icon_pack_option' ) ) {
	function grandprix_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_ion_icon_pack_option' );
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_social_options', 'grandprix_mikado_add_ion_icon_pack_option' );
}

class GrandPrixMikadoClassIonIcons implements iGrandPrixMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
	...
	public function getBackToTopIcon() {
		...
		return $this->render('ion-ios-play');
	}
