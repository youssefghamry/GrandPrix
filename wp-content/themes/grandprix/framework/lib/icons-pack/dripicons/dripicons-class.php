...
if ( ! function_exists( 'grandprix_mikado_add_dripicons_icon_pack' ) ) {
	function grandprix_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new GrandPrixMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_dripicons_icon_pack_option' ) ) {
	function grandprix_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_dripicons_icon_pack_option' );
}

class GrandPrixMikadoClassDripicons implements iGrandPrixMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
