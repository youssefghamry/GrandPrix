...
if ( ! function_exists( 'grandprix_mikado_add_linear_icon_pack' ) ) {
	function grandprix_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new GrandPrixMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_linear_icon_pack_option' ) ) {
	function grandprix_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_linear_icon_pack_option' );
}

class GrandPrixMikadoClassLinearIcons implements iGrandPrixMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
