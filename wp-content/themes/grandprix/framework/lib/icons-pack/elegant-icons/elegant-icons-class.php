...
if ( ! function_exists( 'grandprix_mikado_add_font_elegant_icon_pack' ) ) {
	function grandprix_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new GrandPrixMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_font_elegant_icon_pack_option' ) ) {
	function grandprix_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_social_options', 'grandprix_mikado_add_font_elegant_icon_pack_option' );
}

class GrandPrixMikadoClassIconsFontElegant implements iGrandPrixMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
