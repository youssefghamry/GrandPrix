...
if ( ! function_exists( 'grandprix_mikado_add_simple_line_icon_pack' ) ) {
	function grandprix_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new GrandPrixMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_simple_line_icon_pack_option' ) ) {
	function grandprix_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_social_options', 'grandprix_mikado_add_simple_line_icon_pack_option' );
}

class GrandPrixMikadoClassSimpleLineIcons implements iGrandPrixMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'grandprix'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'grandprix'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'grandprix'),
            'icon-social-facebook'    => esc_html__('Facebook', 'grandprix'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'grandprix'),
            'icon-social-github'      => esc_html__('Github', 'grandprix'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'grandprix'),
            'icon-social-instagram'   => esc_html__('Instagram', 'grandprix'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'grandprix'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'grandprix'),
            'icon-social-reddit'      => esc_html__('Reddit', 'grandprix'),
            'icon-social-skype'       => esc_html__('Skype', 'grandprix'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'grandprix'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'grandprix'),
            'icon-social-spotify'     => esc_html__('Spotify', 'grandprix'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'grandprix'),
            'icon-social-twitter'     => esc_html__('Twitter', 'grandprix'),
            'icon-social-youtube'     => esc_html__('Youtube', 'grandprix')
        );
    }
