...
if ( ! function_exists( 'grandprix_mikado_add_linea_icon_pack' ) ) {
	function grandprix_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new GrandPrixMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_collection', 'grandprix_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'grandprix_mikado_add_linea_icon_pack_option' ) ) {
	function grandprix_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'grandprix' );
		
		return $options;
	}
	
	add_filter( 'grandprix_mikado_filter_add_icon_pack_into_options', 'grandprix_mikado_add_linea_icon_pack_option' );
}

class GrandPrixMikadoClassLineaIcons implements iGrandPrixMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = GRANDPRIX_MIKADO_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
